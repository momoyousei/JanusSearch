...
- This skill does not replace the collection-specialized skill at:
  - `/Users/yangli/Workspace/JanusSearch/paper-search/SKILL.md`
...
1. DB exists for read operations:
   - `/Users/yangli/Workspace/JanusSearch/data/papers.db`
2. Hybrid prerequisites:
   - `/Users/yangli/Workspace/JanusSearch/data/vectors/chroma`
