...
from janussearch.infrastructure.service_config import (
    ...
    llm_base_url as configured_llm_base_url,
    llm_model as configured_llm_model,
)
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    common.add_argument(
        "--embed-base-url",
        default=configured_embed_base_url(DEFAULT_EMBED_BASE_URL),
        help=(
    ...
    common.add_argument(
        "--embed-model",
        default=configured_embed_model(DEFAULT_EMBED_MODEL),
    ...
    common.add_argument(
        "--llm-base-url",
        default=configured_llm_base_url(DEFAULT_LLM_BASE_URL),
        help=f"LLM endpoint base URL (default env JANUS_LLM_BASE_URL or {DEFAULT_LLM_BASE_URL})",
    )
    common.add_argument(
        "--llm-model",
        default=configured_llm_model(DEFAULT_LLM_MODEL),
